...
tp=0.0##in period
Mstar=1.00002384523654261354234
Tstar=7542.0
fblend=1.0
Period=1.0#
Dl=1.0*KPC#
Rstar=1.000067543665345345; 
################################################################################
...
def modelini(pp0):
    #test= lnprob(pp0) 
    #if(test>0):
    Flux2=orbit(pp0,tim, Flux, errf,0)          
    return( Flux2 )    
...
for i in range(ns): 
    mbh=float(0.2+(30.0-0.7)*i/ns/1.0)
    pp0=np.array([mbh, 0.0, 0.0, 0.0 ,Rstar,0.450000346354653])
    fij=open("./exam/paramMBH.dat","a+")
    np.savetxt(fij,pp0.reshape((-1,6)),fmt="%.5f  %.5f   %.5f  %.5f   %.5f   %.5f")
    fij.close(); 
    Flux2=modelini(pp0)
    for k in range(Nm): 
        if(abs(Flux2[k,1]-Flux2[k-1,1])>abs(Flux2[k-1,1]-Flux2[k-2,1]) and abs(Flux2[k,0])<float(1.4/Nm/1.0) ):  
            print(Flux2[k,1], Flux2[k-1,1], Flux2[k-2,1], Flux2[k,0])
            Flux2[k,1]=Flux2[k-3,1]##float(Flux2[k-1,1]+Flux2[k-2,1]+Flux2[k-3,1])/3.0
            
    if(i>6):  k=int(i%7)
    else:     k=i 
    if(i%2==0): plt.plot(Flux2[:,0], Flux2[:,1],color=col[k],ls="-", lw=float(0.14+i*0.08),alpha=1.0,label=r"$M_{\rm{c}}(M_{\odot})=$"+str(round(mbh,1)))
    else:       plt.plot(Flux2[:,0], Flux2[:,1],color=col[k],ls="-", lw=float(0.14+i*0.08),alpha=1.0)
    print("Mbh:  ", mbh)
plt.xlabel(r"$\rm{time}-t_{0}(\rm{Period})$", fontsize=18)
plt.ylabel(r"$\rm{Normalized}~\rm{Flux}$", fontsize=18, labelpad=0.01)
plt.xticks(fontsize=17, rotation=0)
plt.yticks(fontsize=17, rotation=0)
plt.xlim(-0.04, 0.04)
plt.title(r"$\epsilon=0,~i=0^{\circ},~\theta(\rm{deg})=0,~R_{\star}=1.0~R_{\odot},~\Gamma=0.45$",fontsize=18 ,color="k")
plt.legend()
...
fig=plt.figure(figsize=(8, 6))
for i in range(ns): 
    ecen=float(0.+0.75*i/ns/1.0)
    pp0=np.array([10.00004456476,ecen,0.00003745235,0.00006345346, Rstar,0.450000346354653])
    ...
    for k in range(Nm): 
        if(abs(Flux2[k,1]-Flux2[k-1,1])>abs(Flux2[k-1,1]-Flux2[k-2,1]) and abs(Flux2[k,0])<float(1.4/Nm/1.0) ):  
            print(Flux2[k,1], Flux2[k-1,1], Flux2[k-2,1], Flux2[k,0])
            Flux2[k,1]=Flux2[k-5,1]##float(Flux2[k-1,1]+Flux2[k-2,1]+Flux2[k-3,1])/3.0
            
    if(i>6):  k=int(i%7)
    else:     k=i 
    if(i%2==0):plt.plot(Flux2[:,0],Flux2[:,1],color=col[k],ls="-",lw=float(0.17+i*0.08),alpha=1.0,label=r"$\epsilon=$"+str(round(ecen,2)))
    else:      plt.plot(Flux2[:,0],Flux2[:,1],color=col[k],ls="-",lw=float(0.17+i*0.08),alpha=1.0)
    print("Ecen:  ", ecen)
plt.xlabel(r"$\rm{time}-t_{0}(\rm{Period})$", fontsize=18)
plt.ylabel(r"$\rm{Normalized}~\rm{Flux}$", fontsize=18, labelpad=0.01)
plt.xticks(fontsize=17, rotation=0)
plt.yticks(fontsize=17, rotation=0)
plt.xlim(-0.12 , 0.12)
plt.title(r"$M_{\rm{c}}=10~M_{\odot},~i=0^{\circ},~\theta(\rm{deg})=0,~R_{\star}=1.0~R_{\odot},~\Gamma=0.45$",fontsize=18,color="k")
plt.legend()
plt.legend(loc='best',fancybox=True, shadow=True)
plt.legend(prop={"size":16})
fig=plt.gcf()
...
fig=plt.figure(figsize=(8, 6))
for i in range(ns): 
    inc=float(0.0+7.0*i/ns/1.0)
    pp0=np.array([10.0, 0.0, inc ,0.0, 1.0, 0.450000346354653])
    fij=open("./exam/paramInc.dat","a+")
    np.savetxt(fij,pp0.reshape((-1,6)),fmt="%.5f  %.5f   %.5f  %.5f   %.5f   %.5f")
    fij.close(); 
    Flux2=modelini(pp0)
    for k in range(Nm): 
        if(abs(Flux2[k,1]-Flux2[k-1,1])>abs(Flux2[k-1,1]-Flux2[k-2,1]) and abs(Flux2[k,0])<float(1.2/Nm/1.0) ):  
            print(Flux2[k,1], Flux2[k-1,1], Flux2[k-2,1], Flux2[k,0])
            Flux2[k,1]=Flux2[k-3,1]##float(Flux2[k-1,1]+Flux2[k-2,1]+Flux2[k-3,1])/3.0
    ...
    if(i%2==0):plt.plot(Flux2[:,0],Flux2[:,1],color=col[k],ls="-",lw=float(0.17+i*0.08),alpha=1.0,label=r"$i(\rm{deg})=$"+str(round(inc,2)))
    else:      plt.plot(Flux2[:,0],Flux2[:,1],color=col[k],ls="-",lw=float(0.17+i*0.08),alpha=1.0)
...
plt.title(r"$M_{\rm{c}}=10~M_{\odot},~\epsilon=0,~\theta(\rm{deg})=0,~R_{\star}=1.0~R_{\odot},~\Gamma=0.45$",fontsize=18,color="k")
plt.legend()
plt.legend(loc='best',fancybox=True, shadow=True)
plt.legend(prop={"size":16})
fig=plt.gcf()
...
fig=plt.figure(figsize=(8, 6))
for i in range(ns): 
    Rs=float(0.8+0.7*i/ns/1.0)
    pp0=np.array([10.0,  0.0, 0.0 ,0.0, Rs, 0.450000346354653])
    ...
    if(i%2==0):plt.plot(Flux2[:,0],Flux2[:,1],color=col[k],ls="-",lw=float(0.17+i*0.08),alpha=1.0,label=r"$R_{\star}(R_{\odot})=$"+str(round(Rs,2)))
    else:      plt.plot(Flux2[:,0],Flux2[:,1],color=col[k],ls="-",lw=float(0.17+i*0.08),alpha=1.0)
    print("Rs:  ", Rs)
plt.xlabel(r"$\rm{time}-t_{0}(\rm{Period})$", fontsize=18)
plt.ylabel(r"$\rm{Normalized}~\rm{Flux}$", fontsize=18, labelpad=0.01)
...
plt.yticks(fontsize=17, rotation=0)
plt.xlim(-0.04,  0.04)
plt.title(r"$M_{\rm{c}}=10~M_{\odot},~\epsilon=0,~i=0^{\circ},~\theta(\rm{deg})=0,~\Gamma=0.45$",fontsize=18,color="k")
plt.legend()
plt.legend(loc='best',fancybox=True, shadow=True)
plt.legend(prop={"size":16})
fig=plt.gcf()
...
for i in range(ns): 
    ...
    pp0=np.array([ 10.0,  0.5 , 0.00003645364,tet, Rstar, 0.45475647563])
    ...
    if(i%2==0):plt.plot(Flux2[:,0],Flux2[:,1],color=col[k],ls="-",lw=float(0.17+i*0.08),alpha=1.0,label=r"$\theta(\rm{deg})=$"+str(int(tet)))
    else:      plt.plot(Flux2[:,0],Flux2[:,1],color=col[k],ls="-",lw=float(0.17+i*0.08),alpha=1.0)
    print("TETA:  ", tet)
plt.xlabel(r"$\rm{time}-t_{0}(\rm{Period})$", fontsize=18)
plt.ylabel(r"$\rm{Normalized}~\rm{Flux}$", fontsize=18, labelpad=0.01)
...
plt.yticks(fontsize=17, rotation=0)
plt.xlim(-0.05,  0.05)
plt.title(r"$M_{\rm{c}}=10~M_{\odot},~\epsilon=0.5,~i=0^{\circ},~R_{\star}(R_{\odot})=1.0,~\Gamma=0.45$",fontsize=18,color="k")
plt.legend()
plt.legend(loc='best',fancybox=True, shadow=True)
...
for i in range(ns): 
    ...
    pp0=np.array([10.0 , 0.0, 0.00, 0.0 , Rstar, limb])
    ...
    if(i%2==0):plt.plot(Flux2[:,0],Flux2[:,1],color=col[k],ls="-",lw=float(0.17+i*0.08),alpha=1.0,label=r"$\Gamma=$"+str(round(limb,2)))
    else:      plt.plot(Flux2[:,0],Flux2[:,1],color=col[k],ls="-",lw=float(0.17+i*0.08),alpha=1.0)
    print("limb:  ", limb)
plt.xlabel(r"$\rm{time}-t_{0}(\rm{Period})$", fontsize=18)
plt.ylabel(r"$\rm{Normalized}~\rm{Flux}$", fontsize=18, labelpad=0.01)
...
plt.title(r"$M_{\rm{c}}=10~M_{\odot},~\epsilon=0,~i=0^{\circ},~\theta=0^{\circ},~R_{\star}(R_{\odot})=1.0$",fontsize=18,color="k")
plt.legend()
plt.legend(loc='best',fancybox=True, shadow=True)
plt.legend(prop={"size":14})
fig=plt.gcf()
